...
class purchase_order(osv.osv):
    ...
    _columns = {
        ...
        'bid_date': fields.datetime('Bid Received On', readonly=True, help="Date on which the bid was received"),
        'bid_validity': fields.date('Bid Valid Until', help="Date on which the bid expires"),
    }
    _defaults = {
